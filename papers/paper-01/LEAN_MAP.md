...
| Simultaneous closure and generic branch uniqueness | `both_relativeSign_branches_closed_iff`, `reflected_branch_closed_iff_of_branch_closed`, `relativeSign_closed_branch_unique_of_exists` | complete for any real-linear differential operator; exterior-derivative instantiation and existence open |
...
| Eigenvector-free four-root spectral splitting | `fourRootProjector_apply_eq_component`, `fourRootProjector_commutes`, `fourRootProjector_sq`, `fourRootProjectors_sum_eq_one` | complete under four distinct roots and an explicit four-eigenspace decomposition; smooth tensor-field realization open |
| Complete spectral-projector derivative | `projectorDerivative_target_block_zero`, `spectralProjectorDerivative_left`, `spectralProjectorDerivative_right`, `spectralProjectorDerivative_fourBlock` | complete four-block reconstruction from differentiated spectral/idempotence identities; geometric covariant-derivative instantiation open |
| Scalar-amplitude derivatives | `reconstructedQSqDerivative_relation`, `reconstructedDiagonalADerivative_relation`, `reconstructedDiagonalBDerivative_relation`, `reconstructedAmplitudeADerivative_relation`, `reconstructedAmplitudeBDerivative_relation` | complete evaluated rational formulas on the nonzero-gap/nonzero-amplitude branch; smooth geometric instantiation open |
